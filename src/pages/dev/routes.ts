...
import Pages__dev__games__register__index from './games/register/index';
import Pages__dev__games__register__state from './games/register/state';
...
export default {
	app: [
		...
		route('/games/register', Pages__dev__games__register__index),
		route('/games/register/:stateSlug', Pages__dev__games__register__state),
	],
};
