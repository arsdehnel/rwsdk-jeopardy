...
import { KADCheckboxGroup } from './kad-checkbox-group';

const meta: Meta<typeof KADCheckboxGroup> = {
	component: KADCheckboxGroup,
	parameters: {
		layout: 'centered',
	},
};
...
type Story = StoryObj<typeof KADCheckboxGroup>;
